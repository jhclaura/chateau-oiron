...
Properties {
	...
	_RefleLeftColor ("Reflection Left color", COLOR)  = ( .34, .85, .92, 1)
	_RefleRightColor ("Reflection Right color", COLOR)  = ( .34, .85, .92, 1)
...
fixed4 _RefleLeftColor;
fixed4 _RefleRightColor;
...
v2f vert(appdata v)
{
	...
	if(worldPos.z<0) {
		o.color = _RefleRightColor;
	} else {
		o.color = _RefleLeftColor;
	}
